...
from .views import OrderListView, OrderDetailView, OrderItemSearch, OrderItemAdd, OrderItemRemove, AssortmentSearchResult, ItemsFullSearchResult, PartsSearchView
...
urlpatterns = [
    ...
    path('items/<int:item_pk>/remove', OrderItemRemove.as_view(), name='remove_order_item'),
