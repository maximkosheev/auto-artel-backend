...
urlpatterns = [
    ...
    path('<int:pk>/create-additional', OrderCreateAdditionalView.as_view(), name="create_additional"),
    path('<int:pk>/create/', OrderCreateView.as_view(), name="create"),
